 ...
 * @version 0.1
 */
class ParserOriginal {
    private static final Logger LOG = LoggerFactory.getLogger(ParserOriginal.class);
        ...
        do {
            ...
            if (direct_object_index - phrase_bit >= 1) {
                ...
                for (phrase_index = phrase_bit ; phrase_index < direct_object_index; phrase_index++) {
                    ...
                    action.setDirectObjectModifier(string_array[phrase_index]);
